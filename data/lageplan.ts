...
export const lageplan: Lageplan = {
  ...
  titel: "Lageplan",
  einleitung: "Winterthurerstrasse 659, 8051 Zürich, direkt an der Tramhaltestelle Luegisland.",
  karte: {
    anbieter: "google",
  ...
  anreise: text(
    "Mit dem Tram: Linie 9 bis zur Haltestelle Luegisland. Der Salon liegt direkt an der Haltestelle.",
