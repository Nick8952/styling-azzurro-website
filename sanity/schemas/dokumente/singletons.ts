...
export const websiteEinstellungen = defineType({
  ...
  fields: [
    ...
    defineField({ name: "kurzname", title: "Kurzname", type: "string", group: "allgemein", validation: (regel) => regel.required() }),
...
export const startseite = defineType({
  ...
  fields: [
    ...
    defineField({ name: "grussformel", title: "Grussformel", type: "string", group: "willkommen", initialValue: "Wir freuen uns auf Ihren Besuch", validation: (regel) => regel.required() }),
    defineField({ name: "unterzeichnende", title: "Unterzeichnende", type: "string", group: "willkommen", description: "Z. B. «Antonella Rullo und Ida Patella».", validation: (regel) => regel.required() }),
    defineField({ name: "teamTitel", title: "Team: Titel", type: "string", group: "teaser", validation: (regel) => regel.required() }),
    defineField({ name: "teamText", title: "Team: Text", type: "text", rows: 2, group: "teaser", validation: (regel) => regel.required() }),
    defineField({ name: "teamBild", title: "Team: Bild", type: "bild", group: "teaser", validation: (regel) => regel.required() }),
    defineField({ name: "preiseTitel", title: "Preise: Titel", type: "string", group: "teaser", validation: (regel) => regel.required() }),
    defineField({ name: "preiseText", title: "Preise: Text", type: "text", rows: 2, group: "teaser", validation: (regel) => regel.required() }),
    defineField({
      name: "preisAuszug",
    ...
    defineField({ name: "salonTitel", title: "Salon: Titel", type: "string", group: "teaser", validation: (regel) => regel.required() }),
    defineField({ name: "salonText", title: "Salon: Text", type: "text", rows: 2, group: "teaser", validation: (regel) => regel.required() }),
    ...
    defineField({ name: "gaestebuchTitel", title: "Gästebuch: Titel", type: "string", group: "teaser", validation: (regel) => regel.required() }),
...
export const teamseite = defineType({
  ...
  fields: [
    ...
    defineField({ name: "einleitung", title: "Einleitung", type: "text", rows: 2, validation: (regel) => regel.required() }),
...
export const preisliste = defineType({
  ...
  fields: [
    ...
    defineField({ name: "quelle", title: "Herkunft der Preise", type: "string", description: "Erscheint klein unter der Liste.", validation: (regel) => regel.required() }),
    defineField({ name: "seo", title: "Suchmaschinen", type: "seo", validation: (regel) => regel.required() }),
  ],
...
export const gaestebuchseite = defineType({
  ...
  fields: [
    defineField({ name: "titel", title: "Titel", type: "string", validation: (regel) => regel.required() }),
    defineField({ name: "einleitung", title: "Einleitung", type: "text", rows: 2, validation: (regel) => regel.required() }),
    defineField({ name: "neuerEintragTitel", title: "Titel für «neuer Eintrag»", type: "string", validation: (regel) => regel.required() }),
    defineField({ name: "neuerEintragText", title: "Text für «neuer Eintrag»", type: "text", rows: 3, validation: (regel) => regel.required() }),
    defineField({ name: "seo", title: "Suchmaschinen", type: "seo", validation: (regel) => regel.required() }),
  ],
...
export const kontaktseite = defineType({
  ...
  fields: [
    defineField({ name: "titel", title: "Titel", type: "string", validation: (regel) => regel.required() }),
    defineField({ name: "einleitung", title: "Einleitung", type: "text", rows: 2, validation: (regel) => regel.required() }),
    defineField({ name: "terminTitel", title: "Termin: Titel", type: "string", validation: (regel) => regel.required() }),
    defineField({ name: "terminText", title: "Termin: Text", type: "fliesstext", validation: (regel) => regel.required() }),
    defineField({ name: "formularTitel", title: "Formular: Titel", type: "string", validation: (regel) => regel.required() }),
    defineField({ name: "formularText", title: "Formular: Erklärung", type: "text", rows: 3, validation: (regel) => regel.required() }),
    defineField({ name: "seo", title: "Suchmaschinen", type: "seo", validation: (regel) => regel.required() }),
  ],
